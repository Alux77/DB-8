...
#MIGRACIÓN DE MÉTODO INITIALIZE
...
#MIGRACIÓN DE MÉTODO FIND
    def self.find(pk)
      self.where('id = ?', pk).first
    end

#MIGRACIÓN DE MÉTODO NEW_RECORD?
    def new_record?
      self[:id].nil?
    end
